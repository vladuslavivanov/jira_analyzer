...
def send_prompt(prompt: str) -> dict:
    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "Ты — эксперт по качеству задач в системах трекинга (Jira / YouTrack). "
            ...
            temperature=0.2,
            response_format={"type": "json_object"}  # для моделей, поддерживающих JSON mode
        )
